...
(function exposeI18n(global) {
  ...
  const STRINGS = {
    "zh-CN": {
      ...
      "plan.disabled.readonly": "此 App GUI 只有只读权限", "plan.disabled.schema": "Base 结构不支持创建计划", "plan.busyClose": "正在核对提交结果，暂时不能关闭。",
    ...
    en: {
      ...
      "plan.disabled.readonly": "This App GUI is read-only", "plan.disabled.schema": "The Base schema cannot store plans", "plan.busyClose": "The submission outcome is being checked; keep this dialog open.",
    ...
    ja: {
      ...
      "plan.disabled.readonly": "この App GUI は読み取り専用です", "plan.disabled.schema": "Base の構造では計画を保存できません", "plan.busyClose": "送信結果を確認中のため、まだ閉じられません。",
    ...
    fr: {
      ...
      "plan.disabled.readonly": "Cette App GUI est en lecture seule", "plan.disabled.schema": "Le schéma Base ne permet pas les plans", "plan.busyClose": "Le résultat est en cours de vérification ; gardez cette fenêtre ouverte.",
    ...
    es: {
      ...
      "plan.disabled.readonly": "Esta App GUI es de solo lectura", "plan.disabled.schema": "El esquema Base no permite guardar planes", "plan.busyClose": "Se está comprobando el resultado; mantén abierto el diálogo.",
