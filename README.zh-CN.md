...
**它说你的语言。**
界面跟随应用语言——English、简体中文、日本語、Français、Español，并且同一屏里不会中英混排：器械、肌肉、身体部位一律翻译，动作说明按句拆成编号步骤，用你的语言显示（有中文用中文，否则英文）。唯一不翻译的是页脚三条署名——那是许可要求的原文。
...
数据读取失败时可直接点击“重新读取”；界面保留上次完整快照，并继续使用 React、Tailwind CSS、shadcn 与最低 Bottega 0.1.3 的构建约定。
